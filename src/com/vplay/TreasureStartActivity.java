...
//Стартовое меню игры Клад
public class TreasureStartActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_treasure_start);
	...
	private void init_spinners()
	{
		...
		try
		{
			is = asset_manager.open("treasure_game/game_themes.txt");
		}
		catch(IOException e)
		{
		...
		Spinner spinner = (Spinner) findViewById(R.id.treasure_start_game_theme_spinner);
	...
	public void on_click_treasure_start_start_game_button(View v)
	{
		//Получить спинер с GUI интерфейса
		Spinner spinner = (Spinner) findViewById(R.id.treasure_start_game_theme_spinner);		
